...
using WebApiIdentityTEST.Results;

namespace WebApiIdentityTEST.Controllers
{
    [Authorize]
    ...
    public class AccountController : ApiController
    {
        ...
        private IUserManager userManager = System.Web.Http.GlobalConfiguration.Configuration.DependencyResolver.GetService(typeof(IUserManager)) as IUserManager;
