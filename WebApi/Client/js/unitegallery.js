...
function UniteGalleryMain(){
	...
	function toFakeFullScreen(){ 
		...
		$('.ug-slider-wrapper').css('background-color','rgba(0, 0, 0, 0.5)');
		g_objWrapper.addClass("ug-fake-fullscreen");
		$('.ug-strip-panel').css('background-color','rgba(0, 0, 0, 0.5)'); 
		g_temp.isFakeFullscreen = true;
		
		g_objGallery.trigger(t.events.ENTER_FULLSCREEN);
		g_objGallery.trigger(t.events.SIZE_CHANGE);  
		$('.ug-thumbs-strip').css('left',($(window).width()/2-(93*num_imgs)/2)+'px'); 
	}
	...
	function exitFakeFullscreen(){
		...
		$('.ug-slider-wrapper').css('background-color','#fff');
		$('.ug-strip-panel').css('background-color','#fff');
...
function UGLightbox(){
	...
	var g_defaults = {
			...
			lightbox_slider_scale_mode_media: "fill",
			lightbox_slider_scale_mode: "fill",
			...
			lightbox_slider_image_border_color: "red",
